        ...
        <Card className="w-full lg:w-2/3">
          <CardHeader>
            ...
            <CardDescription>
              ...
              alterar seus dados de pagamento e visualizar seu extrato ao mesmo
              tempo.
            </CardDescription>
          </CardHeader>
          <CardContent>
      ...
      <Card className="flex flex-col">
        <CardContent className="py-8">
          ...
          <div className="mt-4 flex items-baseline text-6xl font-extrabold">
            $30 <span className="ml-1 text-2xl text-muted-foreground">/mês</span>
          </div>
          <p className="mt-5 text-lg text-muted-foreground">
            Escreva quantas notas quiser por $30 por mês
          </p>
        </CardContent>
